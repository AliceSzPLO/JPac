...
import static nl.tudelft.jpacman.MultiLevelLauncher.current_map;
...
public class PacManSprites extends SpriteStore {
    ...
    public Map<Direction, Sprite> getPacmanSprites1() {
    ...
    public Sprite getWallSprite() {
        if(current_map == 1){return loadSprite("/sprite/wall.png");
        }else {return loadSprite("/sprite/wall1.png");}
