    ...
    protected void addSquare(Square[][] grid, List<Ghost> ghosts,
        ...
        switch (c) {
            ...
            case 'c':
                ...
                break;
            case '1':
                Square playerSquare1 = boardCreator.createGround();
                grid[x][y] = playerSquare1;
                startPositions.add(playerSquare1);
                break;
            case '2':
                Square playerSquare2 = boardCreator.createGround();
                grid[x][y] = playerSquare2;
                startPositions.add(playerSquare2);
                break;
            case '3':
                Square playerSquare3 = boardCreator.createGround();
                grid[x][y] = playerSquare3;
                startPositions.add(playerSquare3);
                break;
            case '4':
                Square playerSquare4 = boardCreator.createGround();
                grid[x][y] = playerSquare4;
                startPositions.add(playerSquare4);
                break;
            case '5':
                Square playerSquare5 = boardCreator.createGround();
                grid[x][y] = playerSquare5;
                startPositions.add(playerSquare5);
                break;
            default:
